...
sed -i -e 's/dnsmasq/dnsmasq-full luci-app-udpxy luci-app-wireguard luci-ssl-openssl luci-app-acme luci-app-ddns luci-app-upnp acme-dnsapi/' include/target.mk
