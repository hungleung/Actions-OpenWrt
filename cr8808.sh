...
sed -i -e 's/dnsmasq/dnsmasq-full ddns-scripts_cloudflare.com-v4 luci-app-udpxy luci-app-wireguard luci-ssl-openssl luci-app-acme luci-app-ddns luci-app-upnp acme-dnsapi acme-deploy acme-notify luci-app-ssr-plus/' include/target.mk
