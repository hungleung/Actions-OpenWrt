...
# sed -i -e 's/luci-app-arpbind luci-app-filetransfer luci-app-vsftpd/luci-app-udpxy luci-app-passwall luci-app-ssr-plus /' -e 's/luci-app-accesscontrol luci-app-nlbwmon //' -e 's/luci-app-wol/luci-app-wireguard/'  include/target.mk
